    ...
    async def async_step_init(self, user_input=None):
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Optional(CONF_START_TIME, default=self.config_entry.data.get(CONF_START_TIME, DEFAULT_START_TIME)): selector.TimeSelector(),
                vol.Optional(CONF_END_TIME, default=self.config_entry.data.get(CONF_END_TIME, DEFAULT_END_TIME)): selector.TimeSelector(),
            })
        )